...
<th width="10%">price</th><th width="10%">Category Id</th><th width="10%">actions</th>
</tr>
</thead>
<tbody>
...
<td><a href="<spring:url value="/viewProduct/${product.pid}" />"><span class="glyphicon glyphicon-info-sign">View Product</a>
</td>
